...
export default function ResidentLayout() {
  return (
    <div className="relative flex h-screen w-full flex-col overflow-hidden max-w-[430px] mx-auto bg-background-light dark:bg-background-dark shadow-xl dark:shadow-2xl">
      ...
      <nav className="absolute z-10 bottom-0 left-0 right-0 bg-white/95 dark:bg-surface-dark/95 backdrop-blur-xl px-8 pb-8 pt-4 border-t border-slate-200 dark:border-surface-border">
